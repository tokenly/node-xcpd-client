...
XCPDClient.connect = function (opts) {
    ...
    xcpdClient.getLastIssuance = function (assetName) {
        var query = {
        ...
        return xcpdClient.call('get_issuances', xcpdClient.buildQuery(query)).then(function (result) {
    ...
    function buildIsDivisible(assetName) {
        ...
        return xcpdClient.getLastIssuance(assetName).then(function (assetInfo) {
            if (assetInfo == null) {
                return null;
            }
